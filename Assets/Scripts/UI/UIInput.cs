...
//     version 1.19.0
//     from Assets/Scripts/UI/UIInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/UI/UIInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @UIInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""UIControls"",
            ""id"": ""73c82cfc-728f-4085-afc8-d9ea2575f92f"",
            ""actions"": [
                {
                    ""name"": ""OpenMap"",
                    ""type"": ""Button"",
                    ""id"": ""490286bc-5fb6-41d9-809f-2b4f6ba43c89"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Escape"",
                    ""type"": ""Button"",
                    ""id"": ""f029aa2d-987b-4b5c-939e-525e84bd6b4f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""cecf2fe1-7b06-411d-a72d-86f6dc5e2187"",
                    ""path"": ""<Keyboard>/tab"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""48d23871-555a-4652-a97a-f79ab7823aca"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0f289597-5ded-4202-a4ea-06885235fe7e"",
    ...
    ""controlSchemes"": []
        ...
        m_UIControls_OpenMap = m_UIControls.FindAction("OpenMap", throwIfNotFound: true);
        m_UIControls_Escape = m_UIControls.FindAction("Escape", throwIfNotFound: true);
    }

    ~@UIInput()
    {
        UnityEngine.Debug.Assert(!m_UIControls.enabled, "This will cause a leak and performance issues, UIInput.UIControls.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_UIControls_OpenMap;
    ...
    public struct UIControlsActions
    {
        ...
        /// </summary>
        public UIControlsActions(@UIInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "UIControls/OpenMap".
        /// </summary>
        public InputAction @OpenMap => m_Wrapper.m_UIControls_OpenMap;
        /// <summary>
        /// Provides access to the underlying input action "UIControls/Escape".
        /// </summary>
